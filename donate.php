<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO  donatelist (amount,fullName,email,moblieNumber,address,message) VALUES('$amount','$fullname','$email','$number','$address','$note')";
                        ...
                        <div class="donationFromArea">
                            <form action="donate.php" method="POST">
                                <div class="donationAmount">
                                    ...
                                    <input type="text" class="donationAmountInput" name="amount" id="text" placeholder="Enter Donation Amount">
                                </div> <!-- donationAmount -->
                                <div class="donationDetails">
                                    ...
                                    <div class="row d-flex f-wrap">
                                        <div class="col-6 mb-15 plr-15">
                                            <input type="text" class="donationDetailsInput" name="fullname" id="fullname" placeholder="Full Name">
                                        </div> <!-- col 6 -->
                                        <div class="col-6 mb-15 plr-15">
                                            <input type="email" class="donationDetailsInput" name="email" id="email" placeholder="Enter your email">
                                        </div> <!-- col 6 -->
                                        <div class="col-6 mb-15 plr-15">
                                            <input type="text" class="donationDetailsInput" name="number" id="Mnumber" placeholder="Enter valid Moblie Number">
                                        </div> <!-- col 6 -->
                                        <div class="col-6 mb-15 plr-15">
                                ...
                                <div class="submitArea tAlign-center">
                                    <button type="submit" class="themeBtn submitBtn text-white" name="submit">donate now</button>
                                </div> <!-- submitArea -->
                            </form> <!-- form -->
